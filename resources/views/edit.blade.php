...
@section('content')
<div class="container">
    <form method="POST" action="{{route('update', $data['id'])}}" class="row">
        @csrf
        <div class="col-md-4">
        ...
        <div class="col-md-8">
            ...
            <form class="information">
                ...
                <div class="form-group"> 
                    <input type="text" class="form-control @error('merk') is-invalid @enderror" id="merk" name="merk" placeholder="Merk" value="{{$data['merk']}}">
                    @error('merk')
                ...
                <div class="form-group"> 
                    <input type="text" class="form-control @error('type') is-invalid @enderror" id="type" name="type" placeholder="Type" value="{{$data['type']}}">
                    @error('type')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
